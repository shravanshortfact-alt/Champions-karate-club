...
export default function BeltExamForm() {
  ...
  const handleNext = (e: React.FormEvent) => {
    e.preventDefault();
    if (formData.name && formData.age && formData.currentBelt && formData.appearingBelt && formData.coachName && formData.branch) {
      setStep(2);
    } else {
          ...
          <form onSubmit={handleNext}>
            ...
            <div className="grid grid-cols-2">
              ...
              <div className="form-group">
                ...
                <select 
                  value={formData.appearingBelt}
                  onChange={(e) => setFormData({...formData, appearingBelt: e.target.value})}
                  required
                >
        ...
        {step === 2 && (
          <form onSubmit={handleSubmit} style={{ textAlign: 'center' }}>
            ...
            <p style={{ color: 'var(--text-muted)', marginBottom: '2rem' }}>
              Scan the QR Code below to pay the examination fees (₹ {fee}) via UPI.
            </p>
