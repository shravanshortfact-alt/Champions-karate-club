    ...
    <html lang="en">
      ...
      <body>
        ...
        <div style={{ position: 'fixed', right: '20px', bottom: '20px', display: 'flex', flexDirection: 'column', gap: '15px', zIndex: 9999 }}>
          ...
          <a href={settings.instagramLink || "https://instagram.com/"} target="_blank" rel="noopener noreferrer" className="floating-icon" style={{ background: 'linear-gradient(45deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%)' }}>
